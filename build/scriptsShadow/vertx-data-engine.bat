...
set CLASSPATH=%APP_HOME%\lib\vertx-data-engine-1.0.0-SNAPSHOT-fat.jar

@rem Execute vertx-data-engine
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %VERTX_DATA_ENGINE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
